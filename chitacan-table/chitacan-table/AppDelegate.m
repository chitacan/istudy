...
{
    Fruit *apple      = [[Fruit alloc] initWithName:@"Apple" AndDescription:@"red and my fav"];
    Fruit *orange     = [[Fruit alloc] initWithName:@"Orange" AndDescription:@"fresh"];
    Fruit *watermelon = [[Fruit alloc] initWithName:@"Watermelon" AndDescription:@"greennn"];
